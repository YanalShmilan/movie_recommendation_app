...
import 'package:movie_recommendation_app_course/theme/pallette.dart';

class CustomTheme {
  static ThemeData darkTheme(BuildContext context) {
    final theme = Theme.of(context);
    return ThemeData(
       colorScheme: ColorScheme.fromSwatch(primarySwatch: MaterialColor(Palette.red500.value, {
      ...
      },),).copyWith(secondary: Color(Palette.red500.value),
      ),
      sliderTheme: SliderThemeData(activeTrackColor: Colors.white,
